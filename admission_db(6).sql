...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 13, 2023 at 07:53 AM
...
(1, 11, 'Pathanamthitta, omalloor, kaippattoor', 'Pathanamthitta, omalloor, kaippattoor', 1001),
(2, 11, 'Pathanamthitta, konni, pathanapuram', 'Pathanamthitta, konni, pathanapuram', 1002);
...
(3, 4, 13, 'Catholicate College', 'Pathanamthitta', 'catholicate@gmail.com', 8956321245, 259, 'Pathanamthitta');
...
--
ALTER TABLE `tbl_admission_notification`
  MODIFY `admission_notification_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_offer_course`
  MODIFY `offer_course_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
